...
import type { CodeProviderError, CodeProviderOptions } from "../provider/code.js";
...
export interface CodeUIOptions {
   ...
   * ```
   */
  sendCode: (claims: Record<string, string>, code: string) => Promise<undefined | CodeProviderError>;
  /**
